...
openssl x509 -extfile <(printf "subjectAltName=DNS:$SERVER") -req -days 365 -in server.csr -CA ca.pem -CAkey ca-key.pem -passin "pass:$PASSWORD" -CAcreateserial -out server-cert.pem
